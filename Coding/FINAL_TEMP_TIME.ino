...
int tempL_A = 30, tempL_H = 25;      //Temperature limits
...
void setup() {
  ...
  //______TIME_SETUP__________________________________________
...
void loop() {
  ...
  bool timeR = digitalRead(timeP);    //Time Read
  if (timeR == true) {
...
//______TIME_PRINT_______________________________________
